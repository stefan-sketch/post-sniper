        ...
        <div className="flex items-center justify-center gap-2 flex-1">
          ...
          <div className="relative">
            <button
              ...
              className="status-filter-trigger px-2.5 py-0.5 rounded-full text-xs font-medium transition-all bg-white/10 hover:bg-white/20 text-white shadow-sm flex items-center gap-1"
            >
